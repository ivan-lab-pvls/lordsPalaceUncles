...
@RoutePage()
class MagicKitchenScreen extends StatefulWidget {
  const MagicKitchenScreen({super.key});

  @override
  State<MagicKitchenScreen> createState() => _MagicKitchenScreenState();
}

class _MagicKitchenScreenState extends State<MagicKitchenScreen> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/magic-kitchen/bg.png"),
            fit: BoxFit.cover,
          ),
        ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Image.asset('assets/images/magic-kitchen/title.png'),
                    SizedBox(width: 70),
                  ],
                ),
                SizedBox(height: 20),
                ...
                SizedBox(height: 20),
                Image.asset('assets/images/magic-kitchen/avatar.png'),
                SizedBox(
                  width: 190,
                  height: 40,
                  child: Stack(
                    ...
                    children: [
                      SvgPicture.asset(
                          'assets/images/magic-kitchen/bottom-tile.svg'),
                      Text(
                        'Press Spin to Start',
                        style: TextStyle(
                            fontSize: 14,
                ...
                SizedBox(
                  ...
                  child: Stack(
                    ...
                    children: [
                      Image.asset(
                          'assets/images/magic-kitchen/board/board.png'),
                      SizedBox(
                        width: 335,
                        height: 335,
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                              child: Center(
                                child: Image.asset(
                                    'assets/images/magic-kitchen/board/${gridItems[index]}.png'),
                              ),
                            );
                          },
                        ),
