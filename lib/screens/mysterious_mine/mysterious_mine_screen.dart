...
@RoutePage()
class MysteriousMineScreen extends StatefulWidget {
  const MysteriousMineScreen({super.key});

  @override
  State<MysteriousMineScreen> createState() => _MysteriousMineScreenState();
}

class _MysteriousMineScreenState extends State<MysteriousMineScreen> {
  ...
  int endTime() {
    final int levelCountdownTimer = 4 * 60 * 1000 + 30 * 1000;
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/mysterious/bg.png"),
            fit: BoxFit.cover,
          ),
        ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Image.asset('assets/images/mysterious/title.png'),
                    SizedBox(width: 70),
                  ],
                ),
                SizedBox(height: 20),
                ...
                SizedBox(height: 20),
                Image.asset('assets/images/mysterious/avatar.png'),
                SizedBox(
                  width: 190,
                  height: 40,
                  child: Stack(
                    ...
                    children: [
                      SvgPicture.asset(
                          'assets/images/mysterious/bottom-tile.svg'),
                      Text(
                        'Press Spin to Start',
                        style: TextStyle(
                            fontSize: 14,
                ...
                SizedBox(
                  ...
                  child: Stack(
                    ...
                    children: [
                      Image.asset(
                          'assets/images/mysterious/board/board.png'),
                      SizedBox(
                        width: 335,
                        height: 335,
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                              child: Center(
                                child: Image.asset(
                                    'assets/images/mysterious/board/${gridItems[index]}.png'),
                              ),
                            );
                          },
                        ),
